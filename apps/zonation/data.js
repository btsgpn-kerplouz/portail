...
// ---------- III.2 Végétations vivaces des vases salées ----------
{
  ...
  especes:[
    ...
    {latin:"Salicornia perennis", fr:"Salicorne vivace", statut:"freq", niveau:"differentielle"},
    {latin:"Puccinellia maritima", fr:"Puccinellie maritime", statut:"freq"},
    {latin:"Salicornia procumbens s.l.", fr:"Salicorne, groupe procumbens", statut:"freq"},
    {latin:"Limonium vulgare", fr:"Lavande de mer", statut:"freq"}
  ],
  physionomie:"Végétation herbacée dressée, nettement dominée par la Spartine maritime, en îlots ou prés plus ou moins denses. Hauteur moyenne de 10 à 40 cm selon les relevés.",
...
// ---------- III.3 Communautés éphémères des vases salées ----------
{
  ...
  especes:[
    {latin:"Salicornia procumbens s.l.", fr:"Salicorne, groupe procumbens", statut:"car"},
    {latin:"Salicornia europaea s.l.", fr:"Salicorne, groupe europaea", statut:"freq", niveau:"unite_superieure"},
    {latin:"Suaeda maritima", fr:"Soude maritime", statut:"freq", niveau:"unite_superieure"},
    {latin:"Salicornia perennis", fr:"Salicorne vivace", statut:"freq"},
    {latin:"Puccinellia maritima", fr:"Puccinellie maritime", statut:"freq"},
...
// ---------- III.3 (suite) ----------
{
  ...
  especes:[
    {latin:"Salicornia europaea s.l.", fr:"Salicorne, groupe europaea", statut:"car"},
    {latin:"Suaeda maritima", fr:"Soude maritime", statut:"car"},
    {latin:"Salicornia procumbens s.l.", fr:"Salicorne, groupe procumbens", statut:"freq", niveau:"differentielle"},
    {latin:"Puccinellia maritima", fr:"Puccinellie maritime", statut:"freq"},
    {latin:"Elymus pycnanthus", fr:"Chiendent du littoral", statut:"freq"},
    {latin:"Halimione portulacoides", fr:"Obione faux-pourpier", statut:"freq"},
    {latin:"Salicornia perennis", fr:"Salicorne vivace", statut:"freq"},
    {latin:"Salicornia pruinosa", fr:"Salicorne ligneuse", statut:"freq"},
    {latin:"Limonium vulgare", fr:"Lavande de mer", statut:"freq"},
...
// ---------- III.4 Fourrés nains crassulescents littoraux ----------
{
  ...
  especes:[
    {latin:"Salicornia perennis", fr:"Salicorne vivace", statut:"car"},
    {latin:"Puccinellia maritima", fr:"Puccinellie maritime", statut:"car"},
    {latin:"Halimione portulacoides", fr:"Obione faux-pourpier", statut:"freq", niveau:"differentielle"},
...
},
{
  ...
  especes:[
    ...
    {latin:"Salicornia perennis", fr:"Salicorne vivace", statut:"freq", niveau:"differentielle"},
    {latin:"Limonium vulgare", fr:"Lavande de mer", statut:"freq"},
    {latin:"Salicornia sp.", fr:"Salicorne indéterminée", statut:"freq"},
    {latin:"Aster tripolium", fr:"Aster maritime", statut:"freq"},
    {latin:"Plantago maritima", fr:"Plantain maritime", statut:"freq"},
    {latin:"Puccinellia maritima", fr:"Puccinellie maritime", statut:"freq"},
    {latin:"Spartina maritima", fr:"Spartine maritime", statut:"freq"},
...
},
{
  ...
  especes:[
    {latin:"Salicornia pruinosa", fr:"Salicorne ligneuse", statut:"car"},
    {latin:"Salicornia perennis", fr:"Salicorne vivace", statut:"freq", niveau:"differentielle"},
    {latin:"Halimione portulacoides", fr:"Obione faux-pourpier", statut:"freq", niveau:"unite_superieure"},
    {latin:"Puccinellia maritima", fr:"Puccinellie maritime", statut:"freq"},
    {latin:"Plantago maritima", fr:"Plantain maritime", statut:"freq"},
    {latin:"Aster tripolium", fr:"Aster maritime", statut:"freq"},
    {latin:"Limonium vulgare", fr:"Lavande de mer", statut:"freq"},
...
},
{
  ...
  especes:[
    ...
    {latin:"Halimione portulacoides", fr:"Obione faux-pourpier", statut:"freq", niveau:"unite_superieure"},
    {latin:"Salicornia pruinosa", fr:"Salicorne ligneuse", statut:"freq", niveau:"unite_superieure"},
    {latin:"Juncus maritimus", fr:"Jonc maritime", statut:"freq"},
    {latin:"Suaeda maritima", fr:"Soude maritime", statut:"freq"},
    {latin:"Salicornia perennis", fr:"Salicorne vivace", statut:"freq"},
    {latin:"Puccinellia maritima", fr:"Puccinellie maritime", statut:"freq"}
...
// ---------- III.5 Prés salés et prairies saumâtres ----------
{
  ...
  especes:[
    ...
    {latin:"Halimione portulacoides", fr:"Obione faux-pourpier", statut:"car"},
    {latin:"Salicornia procumbens s.l.", fr:"Salicorne, groupe procumbens", statut:"freq", niveau:"differentielle"},
    {latin:"Aster tripolium", fr:"Aster maritime", statut:"freq", niveau:"unite_superieure"},
    {latin:"Limonium vulgare", fr:"Lavande de mer", statut:"freq", niveau:"unite_superieure"},
    {latin:"Spergularia media", fr:"Spergulaire intermédiaire", statut:"freq", niveau:"unite_superieure"},
    {latin:"Suaeda maritima", fr:"Soude maritime", statut:"freq"},
    {latin:"Salicornia europaea s.l.", fr:"Salicorne, groupe europaea", statut:"freq"}
  ],
...
},
{
  ...
  especes:[
    ...
    {latin:"Halimione portulacoides", fr:"Obione faux-pourpier", statut:"freq", niveau:"differentielle"},
    {latin:"Suaeda maritima", fr:"Soude maritime", statut:"freq", niveau:"differentielle"},
    {latin:"Aster tripolium", fr:"Aster maritime", statut:"freq", niveau:"unite_superieure"},
    {latin:"Triglochin maritima", fr:"Troscart maritime", statut:"freq", niveau:"unite_superieure"},
    {latin:"Plantago maritima", fr:"Plantain maritime", statut:"freq", niveau:"unite_superieure"},
    {latin:"Limonium vulgare", fr:"Lavande de mer", statut:"freq", niveau:"unite_superieure"},
    {latin:"Atriplex prostrata", fr:"Arroche couchée", statut:"freq", niveau:"unite_superieure"},
    {latin:"Glaux maritima", fr:"Glaux maritime", statut:"freq", niveau:"unite_superieure"},
    {latin:"Cochlearia anglica", fr:"Cochléaire anglaise", statut:"freq", niveau:"unite_superieure"},
...
},
{
  ...
  especes:[
    ...
    {latin:"Salicornia perennis", fr:"Salicorne vivace", statut:"freq", niveau:"differentielle"},
    {latin:"Cochlearia anglica", fr:"Cochléaire anglaise", statut:"freq", niveau:"unite_superieure"},
    {latin:"Puccinellia maritima", fr:"Puccinellie maritime", statut:"freq", niveau:"unite_superieure"},
    {latin:"Armeria maritima", fr:"Armérie maritime", statut:"freq", niveau:"unite_superieure"},
    {latin:"Aster tripolium", fr:"Aster maritime", statut:"freq", niveau:"unite_superieure"},
    {latin:"Juncus gerardi", fr:"Jonc de Gérard", statut:"freq", niveau:"unite_superieure"},
    {latin:"Festuca rubra subsp. litoralis", fr:"Fétuque littorale", statut:"freq", niveau:"unite_superieure"},
    {latin:"Spergularia media", fr:"Spergulaire intermédiaire", statut:"freq", niveau:"unite_superieure"},
    {latin:"Halimione portulacoides", fr:"Obione faux-pourpier", statut:"freq"},
    {latin:"Salicornia sp.", fr:"Salicorne indéterminée", statut:"freq"},
...
},
{
  ...
  especes:[
    ...
    {latin:"Schoenus nigricans", fr:"Choin noirâtre", statut:"freq", niveau:"differentielle"},
    {latin:"Juncus gerardi", fr:"Jonc de Gérard", statut:"freq", niveau:"unite_superieure"},
    {latin:"Glaux maritima", fr:"Glaux maritime", statut:"freq", niveau:"unite_superieure"},
    {latin:"Plantago maritima", fr:"Plantain maritime", statut:"freq", niveau:"unite_superieure"},
    {latin:"Limonium vulgare", fr:"Lavande de mer", statut:"car"},
...
// ---------- III.6 Pelouses annuelles halophiles littorales ----------
{
  ...
  especes:[
    ...
    {latin:"Juncus bufonius subsp. minutulus", fr:"Jonc des crapauds", statut:"freq", niveau:"differentielle"},
    {latin:"Juncus gerardi", fr:"Jonc de Gérard", statut:"freq", niveau:"differentielle"},
    {latin:"Agrostis stolonifera var. pseudopungens", fr:"Agrostide maritime", statut:"freq", niveau:"differentielle"},
    {latin:"Catapodium marinum", fr:"Catapode marin", statut:"freq", niveau:"unite_superieure"},
    {latin:"Elymus pycnanthus", fr:"Chiendent du littoral", statut:"freq"},
    {latin:"Festuca rubra subsp. litoralis", fr:"Fétuque littorale", statut:"freq"},
...
// ---------- III.7 Prairies du très haut schorre ----------
{
  ...
  especes:[
    ...
    {latin:"Juncus maritimus", fr:"Jonc maritime", statut:"freq", niveau:"differentielle"},
    {latin:"Festuca rubra subsp. litoralis", fr:"Fétuque littorale", statut:"freq"},
...
const TAXON_PHYTOSCOPE = {
  ...
  "Salicornia pruinosa": 6139,
  "Salicornia perennis": 683,
  "Aster tripolium": 787,
  ...
  "Salicornia europaea s.l.": 6050,
  "Salicornia procumbens s.l.": 6052,
